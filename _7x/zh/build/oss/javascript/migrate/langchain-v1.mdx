...
本迁移指南概述了 LangChain v1 中的主要变更。要了解 v1 新功能的更多信息，请参阅[介绍文章](/oss/javascript/releases/langchain-v1)。
...
有关更多详细信息，请参阅内容块[参考文档](/oss/javascript/langchain/messages#content-block-reference)。
